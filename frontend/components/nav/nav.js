                    ...
                    <div className="mx-auto max-w-7xl px-4 lg:px-8">
                        <div className="flex justify-between items-center h-16">
                            ...
                            <div className="flex-shrink-0">
                                <Link href={"/"}><a><img alt={siteName} className="block w-auto h-10 md:hidden"
                                                         src={getStrapiMedia(icon)}/></a></Link>
                                <Link href={"/"}><a><img alt={siteName} className="hidden w-auto h-10 md:block"
                                                         src={getStrapiMedia(logo)}/></a></Link>
                            </div>
                            ...
                            {defaultNav.map((item) => {
                                return (
                                    <div className="block px-6 py-1 border-t border-border-tertiary" key={item.id}>
                                        <Disclosure.Button as="a" href={`/${item.link}`}
